...
namespace Framework
{
	...
	{
		m_m[0]	= 1.0f;	m_m[1]	= 0.0f;	m_m[2]	= 0.0f;	m_m[3]	= 0.0f;
		m_m[4]	= 0.0f;	m_m[5]	= 1.0f;	m_m[6]	= 0.0f;	m_m[7]	= 0.0f;
		m_m[8]	= 0.0f;	m_m[9]	= 0.0f;	m_m[10] = 1.0f; m_m[11] = 0.0f;
		m_m[12] = 0.0f; m_m[13] = 1.0f; m_m[14] = 0.0f; m_m[15] = 1.0f;
	}
	...
	GMATRIX& Matrix4::GetD3DMatrix()
	{
		_updateD3D();
		return m_d3dmatrix;
	}

	void Matrix4::SetD3DMatrix(GMATRIX& matrix)
	{
		m_d3dmatrix = matrix;
		m_m[0]	= m_d3dmatrix.m[0][0];
		m_m[1]	= m_d3dmatrix.m[0][1];
		m_m[2]  = m_d3dmatrix.m[0][2];
		m_m[3]	= m_d3dmatrix.m[0][3];
		m_m[4]	= m_d3dmatrix.m[1][0];
		m_m[5]	= m_d3dmatrix.m[1][1];
		m_m[6]	= m_d3dmatrix.m[1][2];
		m_m[7]	= m_d3dmatrix.m[1][3];
		m_m[8]	= m_d3dmatrix.m[2][0];
		m_m[9]	= m_d3dmatrix.m[2][1];
		m_m[10] = m_d3dmatrix.m[2][2];
		m_m[11] = m_d3dmatrix.m[2][3];
		m_m[12] = m_d3dmatrix.m[3][0];
		m_m[13] = m_d3dmatrix.m[3][1];
		m_m[14] = m_d3dmatrix.m[3][2];
		m_m[15] = m_d3dmatrix.m[3][3];
	}

	void Matrix4::_updateD3D()
	{
		m_d3dmatrix.m[0][0] = m_m[0];
		m_d3dmatrix.m[0][1] = m_m[1];
		m_d3dmatrix.m[0][2] = m_m[2];
		m_d3dmatrix.m[0][3] = m_m[3];
		m_d3dmatrix.m[1][0] = m_m[4];
		m_d3dmatrix.m[1][1] = m_m[5];
		m_d3dmatrix.m[1][2] = m_m[6];
		m_d3dmatrix.m[1][3] = m_m[7];
		m_d3dmatrix.m[2][0] = m_m[8];
		m_d3dmatrix.m[2][1] = m_m[9];
		m_d3dmatrix.m[2][2] = m_m[10];
		m_d3dmatrix.m[2][3] = m_m[11];
		m_d3dmatrix.m[3][0] = m_m[12];
		m_d3dmatrix.m[3][1] = m_m[13];
		m_d3dmatrix.m[3][2] = m_m[14];
		m_d3dmatrix.m[3][3] = m_m[15];
	}
}
